...
3. Generating Random Structure using SQS technique or WC-Short range order (SRO) or SAE method (anyone can be used)

   Python script to generate BCC/FCC/HCP random structures. This program is the MODIFICATION of the NANOHUB code.
